...
if(b==d)
L = ceil((((sqrt(area_footing))*1000)/100))*100;
printf("L = %d mm \n",L)
B = ceil((((sqrt(area_footing))*1000)/100))*100;
printf("B = %d mm \n",B)
elseif(b~=d)
L = ceil((sqrt(1.5*(area_footing*1000000)))/100)*100;
printf("L = %d mm \n",L)
B = ceil(((area_footing*1000000)/L)/100)*100;
printf("B = %d mm \n",B)
endif
endfunction